...
import com.szl.zhaozhao2.view.pinnedheaderlist.PinnedSectionListView;
...
public class PullToRefreshPinnedSectionListView extends
		PullToRefreshAdapterViewBase<PinnedSectionListView> {
	...
	public ContextMenuInfo getContextMenuInfo() {
		return ((InternalPinnedSectionListView) getRefreshableView())
				.getContextMenuInfo();
	}
	...
	@Override
	protected final PinnedSectionListView createRefreshableView(
			Context context, AttributeSet attrs) {
		PinnedSectionListView lv = new InternalPinnedSectionListView(context,
				attrs);
	...
	class InternalPinnedSectionListView extends PinnedSectionListView implements
