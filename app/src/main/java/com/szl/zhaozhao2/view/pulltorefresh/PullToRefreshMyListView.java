...
import com.szl.zhaozhao2.view.MyListView;
...
public class PullToRefreshMyListView extends
	...
	public PullToRefreshMyListView(Context context, Mode mode) {
		super(context, mode);
		setDisableScrollingWhileRefreshing(false);
		// setLoadingLayoutBg(android.R.color.white);
	}
	...
	@Override
	protected final MyListView createRefreshableView(Context context,
													 AttributeSet attrs) {
		MyListView lv = new InternalListView(context, attrs);
	...
	class InternalListView extends MyListView implements
		...
		public void setEmptyView(View emptyView) {
			PullToRefreshMyListView.this.setEmptyView(emptyView);
		}
