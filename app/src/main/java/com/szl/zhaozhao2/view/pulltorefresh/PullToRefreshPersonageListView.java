...
import com.szl.zhaozhao2.view.PersonageListView;
...
public class PullToRefreshPersonageListView extends
	...
	public PullToRefreshPersonageListView(Context context) {
		super(context);
		setDisableScrollingWhileRefreshing(false);
		// setLoadingLayoutBg(android.R.color.white);
	}

	public PullToRefreshPersonageListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		setDisableScrollingWhileRefreshing(false);
		// setLoadingLayoutBg(android.R.color.white);
	}

	public PullToRefreshPersonageListView(Context context, Mode mode) {
		super(context, mode);
		setDisableScrollingWhileRefreshing(false);
		// setLoadingLayoutBg(android.R.color.white);
	}
	...
	public void setPullLabel(String pullDownLabel, String pullUpLabel, Mode mode) {
		super.setPullLabel(pullDownLabel, pullUpLabel, mode);

		if (null != mHeaderLoadingView && mode.canPullDown()) {
			mHeaderLoadingView.setPullLabel(pullDownLabel);
		}
		if (null != mFooterLoadingView && mode.canPullUp()) {
			mFooterLoadingView.setPullLabel(pullUpLabel);
		}
	}

	public void setLoadingLayoutBg(int bg) {
		mHeaderLoadingView.setBackgroundResource(bg);
		mFooterLoadingView.setBackgroundResource(bg);
	}
	...
	@Override
	protected final PersonageListView createRefreshableView(Context context,
															AttributeSet attrs) {
		PersonageListView lv = new InternalListView(context, attrs);
	...
	class InternalListView extends PersonageListView implements
		...
		public void setEmptyView(View emptyView) {
			PullToRefreshPersonageListView.this.setEmptyView(emptyView);
		}
